...
?>
                          ...
                          <a href="manage-notice-copy.php"><span class="report-count"> View Notices</span></a>
                        </div>
...
?>
                          <span class="report-title">Total Class Notice</span>
                          <h4><?php echo htmlentities($totnotice);?></h4>
                          <a href="manage-notice-copy-copy.php"><span class="report-count"> View Notices</span></a>
                        </div>
                        <div class="inner-card-icon bg-warning">
                          <i class="icon-doc"></i>
                        </div>
